...
func init() {
	...
	if err == nil {
		...
		settingCfg = "{\"webdav_user_name\":\"\",\"webdav_user_psw\":\"\",\"webdav_server_port\":18123,\"webdav_file_path\":\".\",\"list_server_path\":\"/list/\",\"list_file_path\":\".\"}"
...
func main() {
	...
	port_float64, _ := strconv.ParseFloat(fmt.Sprintf("%f", webDavConfig["server_port"]), 64) //从interface转化到float64 再到int 再到port_str
	server_port_string = fmt.Sprintf("%d", int(port_float64))
...
>>>>>>> 6341efaa863c9155cd8e92d15c9bc5d61eb62067
